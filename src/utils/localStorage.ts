...
export const initializeDefaultData = (): void => {
  ...
  if (existingAmbulances.length === 0) {
    const defaultAmbulances: Ambulance[] = [
      ...
      { id: 'amb-003', name: 'Calahorra SVA', type: 'SVA', lat: 42.303073, lng: -1.959470, base: 'C/ Severo Ochoa s/n', schedule: '24 h', available: true },
      ...
      { id: 'amb-009', name: 'Haro SVA', type: 'SVA', lat: 42.574701, lng: -2.849061, base: 'Centro de Salud Haro', schedule: '24 h', available: true },
      ...
      { id: 'amb-013', name: 'CARPA Logroño SVB (2)', type: 'SVB', lat: 42.465834, lng: -2.440869, base: 'C. Obispo Lepe, S/N', schedule: '24 h', available: true },
      { id: 'amb-014', name: 'CARPA Logroño SVA', type: 'SVA', lat: 42.465834, lng: -2.440869, base: 'C. Obispo Lepe, S/N', schedule: '24 h', available: true },
