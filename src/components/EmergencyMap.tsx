...
import { SidebarProvider } from "@/components/ui/sidebar"; // Aseguramos import
...
const EmergencyMap: React.FC = () => {
  ...
  // Cambiamos aquí el layout: SidebarProvider en nivel superior, layout root 'flex w-full h-screen'
  return (
    <SidebarProvider>
      <div className="flex flex-col lg:flex-row w-full h-screen bg-gray-50">
        {/* Lateral y mapa, ambos deben crecer en flex y altura */}
        {/* Menu lateral colapsable y hamburguesa ya están en MapControls */}
        <MapControls
